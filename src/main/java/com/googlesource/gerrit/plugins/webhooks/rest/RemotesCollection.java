...
public class RemotesCollection
  ...
  private final UpsertWebhook.Inserter.Factory inserterFactory;
  ...
  RemotesCollection(
      ...
      UpsertWebhook.Inserter.Factory inserterFactory) {
    this.views = views;
  ...
  public UpsertWebhook.Inserter create(ProjectWebhooksResource parent, IdString id) {

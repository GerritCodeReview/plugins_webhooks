...
import static com.googlesource.gerrit.plugins.webhooks.processors.GerritEventProcessor.TYPE;
...
public class Factories {
  ...
  @Inject
  protected Factories(DynamicSet<EventProcessor.Factory> factories) {
    this.factories = new HashMap<>();
    factories.forEach(
        (factory) -> {
          this.factories.put(factory.type().toLowerCase(), factory);
        });
  }

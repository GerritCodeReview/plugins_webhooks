...
import com.googlesource.gerrit.plugins.webhooks.rest.UpsertWebhook;
...
public class WebhooksConfig extends VersionedMetaData {
  ...
  @Inject
  WebhooksConfig(@PluginName String pluginName) {
    this.cfgFileName = pluginName + ".config";
  }
  ...
  public void upsertRemote(String name, UpsertWebhook.Input in) {

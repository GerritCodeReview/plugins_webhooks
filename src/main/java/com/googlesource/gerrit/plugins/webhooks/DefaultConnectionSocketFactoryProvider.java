...
class DefaultConnectionSocketFactoryProvider implements Provider<Registry<ConnectionSocketFactory>> {
  private static final Logger log = LoggerFactory.getLogger(DefaultConnectionSocketFactoryProvider.class);

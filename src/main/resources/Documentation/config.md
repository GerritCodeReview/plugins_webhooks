...
:   When 'true' SSL certificate verification of all webhooks is NOT performed
...
: When 'true' SSL certificate verification of remote url is NOT performed
  when payload is delivered, the default value is derrived from global configuration.